"""v18: v7 ridge ensemble + regularized XGBoost leg (small, more L2).

XGBoost with shallower depth, fewer rounds, larger reg_lambda — aiming
for better generalization across folds (not just fold 3).
"""
...
class Model:
    ...
    def predict(self, X: pd.DataFrame) -> pd.DataFrame:
        ...
        return (2 * zscore(leg_target) + 2 * zscore(direct_df) + zscore(xgb_target)) / 5.0
