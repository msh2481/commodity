"""v30: v28 + volume features in direct+xgb feature set.

Adds ~214 volume/open-interest features (log z-score + log 5-day change).
Only applied to the DIRECT and XGBoost members — not leg ridge which uses
clean wide features only.
"""
