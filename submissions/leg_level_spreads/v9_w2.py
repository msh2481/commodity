"""v9: weight-tunable z-score ensemble.

Same two members as v7; global scalar WEIGHT_LEG controls the mixture.
"""
...
class Model:
    ...
    def predict(self, X: pd.DataFrame) -> pd.DataFrame:
        ...
        return WEIGHT_LEG * zscore(leg_target) + (1 - WEIGHT_LEG) * zscore(direct_df)
