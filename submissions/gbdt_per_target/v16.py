"""v16: v14 hparams variant — slightly deeper trees, more iterations.

Same features as v14 (8 LME + 3 spread). Hparams:
  - n_estimators=200 (up from 100)
  - max_depth=5 (up from 4)
  - learning_rate=0.03 (down)
  - min_child_weight=10 (up)
...
class Model:
    ...
    def fit(self, X, y):
        ...
        for tgt in self._target_cols:
            ...
            X_j = np.hstack([lme, spread_cache[pair]]) if pair in spread_cache else lme
