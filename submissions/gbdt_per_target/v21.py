"""v21: v15 with subsample=0.8, colsample_bytree=0.8 (add tree-level stochasticity).

Same features as v15 (8 LME + 3 cal + per-target multi-window spread).
Adds subsample/colsample regularization that v15 lacked.
"""
