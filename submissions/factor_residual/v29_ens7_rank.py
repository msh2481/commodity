"""v29 — v24 (best) + v27 (rank-target). Rank-target model is strong on fold 3
and structurally different, should help ensemble."""
...
from v27_pt_rank_tgt import Model as MG
